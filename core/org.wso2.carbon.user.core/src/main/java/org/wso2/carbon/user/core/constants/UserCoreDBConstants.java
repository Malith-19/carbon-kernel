...
public class UserCoreDBConstants {
    ...
    public static final String GET_DISTINCT_USER_IDS_FROM_USER_ATTRIBUTE_SQL =
            "SELECT DISTINCT U.UM_USER_ID FROM UM_USER U INNER JOIN UM_USER_ATTRIBUTE UA ON U.UM_ID = UA.UM_USER_ID";

    public static final String GET_DISTINCT_USER_NAMES_FROM_USER_ATTRIBUTE_SQL =
            "SELECT DISTINCT U.UM_USER_NAME FROM UM_USER U INNER JOIN UM_USER_ATTRIBUTE UA ON U.UM_ID = UA.UM_USER_ID";
}
